(function($) {
    $.common = function(el, options) {
        ...
        $common.addCart ={
            ...
            showPop:function(data,el){
               ...
               if(data.result=="success" ){
                	...
                	var popurl=$common.dev.getPopUrl("addCartFail");
                    new $.popup.show({url:popurl,
                        complete:function(data){
                            $("body").append(data);
                            $(".minicart").addClass('hover');
		...
		$common.searchHead={
		    event:function(){
		        $(".headSearchBtn").click(function(){$common.searchHead.areaShow($(this));});
		        $(".closeSearch").click(function(){$common.searchHead.areaHide($(this));});
		    },
        ...
        $common.dev={
            ...
            getPopUrl:function(key){
                try{return getPopUrl(key);}catch(e){
                    ...
                    //mini购物车
                    if(key=="addCart")return "component/popup_addcart_succes.html";
					//邮件弹层
            ...
            getAddCart:function(el,callback){
                try{setAddCart(el,callback);}catch(e){setTimeout(function(){callback({result:"success"});},1000);};
            },
